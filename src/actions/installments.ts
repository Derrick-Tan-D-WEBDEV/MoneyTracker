...
export async function getInstallments() {
  ...
  return installments.map((i) => ({
    ...
    totalAmount: decryptAmount(i.totalAmount, encKey),
    monthlyPayment: decryptAmount(i.monthlyPayment, encKey),
    totalMonths: i.totalMonths,
    paidMonths: i.paidMonths,
    remainingMonths: i.totalMonths - i.paidMonths,
    remainingAmount: decryptAmount(i.monthlyPayment, encKey) * (i.totalMonths - i.paidMonths),
    paidAmount: decryptAmount(i.monthlyPayment, encKey) * i.paidMonths,
    interestRate: decryptAmount(i.interestRate, encKey),
...
export async function createInstallment(data: z.input<typeof installmentSchema>) {
  ...
  await db.installment.create({
    data: {
      ...
      totalAmount: encryptAmount(parsed.totalAmount, encKey),
      monthlyPayment: encryptAmount(monthlyPayment, encKey),
